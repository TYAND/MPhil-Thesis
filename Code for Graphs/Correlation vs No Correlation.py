...
data_df = pd.read_csv("C:\Users\Asus\Desktop\Output Data\Results (Final)\Correlation pre-screen\Corr & No Corr (2).csv")
...
for i in [9]:
	...
	for j in [15, 19, 17, 18, 32]:
			...
			if length == 1:
				...
				label_lst=["No Correlation Screening", "Correlation Screening"]
